    ...
    try {
      ...
      if (!productsError && products) {
        ...
        this.recommendedProducts = products.map(p => ({
          ...
          image_urls: p.image_url || ['/assets/images/placeholder.jpg'],
        ...
        this.recommendedProducts = [
          ...
          },
          {
            ...
            image_urls: ['/assets/images/products/gear-oil-1.jpg'],
            is_active: true,
            created_at: now,
            created_by: 'system',
            packages: [
          ...
          },
          {
            ...
            image_urls: ['/assets/images/products/hydraulic-oil-1.jpg'],
            is_active: true,
            created_at: now,
            created_by: 'system',
            packages: [
          ...
          },
          {
            ...
            image_urls: ['/assets/images/products/grease-1.jpg'],
            is_active: true,
            created_at: now,
            created_by: 'system',
            packages: [
